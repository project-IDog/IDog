                    ...
                    <ScrollView horizontal={true} style={ProfileLayout.nftList}>
                        ...
                        </GestureFlipView>
                        {
                            dogList.map((dogItem:any, index:any) => {
                                console.log(dogItem.dogNo);
                                return(
                                    <View key={index} style={{marginLeft:10}}>
                                        <NftProfile dogName={`내 반려견 ${dogItem.dogName}`} createdTitle="등록한 날짜" createdAt="2023. 09. 02." species={dogItem.dogBreed} bgImg={dogItem.dogImg} dogNo={dogItem.dogNo}/>
                                    </View>
                                );
                            })
                        }
