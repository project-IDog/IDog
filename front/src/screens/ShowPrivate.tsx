...
const ShowPrivate = ({navigation}: any) => {
    ...
    const showMyPrivateKey = async () => {
        await axios.post('/user/wallet/check',{
    ...
    return(
        <>
            <CommonLayout>
                ...
                <SubMain subTitle="개인키 확인" mainTitle={`내 반려견과\n함께하는 매일,\n간편하게 관리될 수 있도록.`} bgImg={MyPageMainImg} desc="내 개인키 확인하기"/>
                <View style={EditMypageLayout.editMyPageTitleWrap}>
                    <Text style={EditMypageLayout.editMyPageTitle}>
                        나의 소중한 지갑 개인키{"\n"}
                        <Text style={EditMypageLayout.boldEditMyPageTitle}>안전하게</Text> 확인해드려요.
                    </Text>
                ...
                <View style={EditMypageLayout.editMyPageFormWrap}>
                    <Text style={EditMypageLayout.editMyPageFormText}>고객님의 소중한 비밀번호를 입력해주세요.</Text>
                    <TextInput
                ...
                <View style={EditMypageLayout.editMyPageButtonWrap}>
                    <TouchableOpacity activeOpacity={0.7} onPress={() => showMyPrivateKey()}>
                        <View style={EditMypageLayout.editButton}>
                            <Text style={EditMypageLayout.editButtonText}>나의 개인키 확인하기</Text>
                        </View>
                    </TouchableOpacity>
