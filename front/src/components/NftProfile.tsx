...
const NftProfile = ({dogName, createdTitle, createdAt, species, bgImg, dogNo} : any) => {
        ...
        <>
            <View style={NftProfileLayout.nftProfileWrap}>
                <ImageBackground source={{uri:bgImg}} style={NftProfileLayout.puppyThumbnail} imageStyle={{borderRadius:10}}>
                    ...
                    <TouchableOpacity activeOpacity={0.7} style={NftProfileLayout.editButtonWrap} onPress={() => navigation.navigate('EditProfile', {selectedNo: dogNo})}>
                        <View style={NftProfileLayout.editButton}><Text style={NftProfileLayout.editButtonText}>상세보기</Text></View>
                    </TouchableOpacity>
                </ImageBackground>
            </View>
        </>
