...
import MainLayout from './src/styles/mainLayout';
      ...
      <CommonLayout>
        ...
        <View style={MainLayout.tribeWrap}>
          ...
          <View style={MainLayout.tribeInfoWrap}>
            ...
            <TouchableOpacity activeOpacity={0.7}>
              <View style={MainLayout.moveTribeButton}><Text style={MainLayout.moveTribeButtonText}>온라인 추모공원 둘러보기</Text></View>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={MainLayout.randingButtonWrap}>
          <Text style={MainLayout.randingTitle}><Text style={MainLayout.boldRandingTitle}>김싸피</Text> 님을 위한 내 반려견 서비스</Text>
