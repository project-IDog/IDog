...
public class ScheduelServiceImpl {
    ...
    public void updateDogNftByTokenId() { //10분마다
        ...
        List<Dog> dogList = dogRepository.findByDogHashIsNotNullAndCanceled(
        ...
        for (int i = 0; i < dogList.size(); i++) {
            ...
            String searchUri =
                "?module=account&action=tokennfttx&contractaddress=0xdB983532a92837Ee0faF0e67854993a858f621d2&address="
                    + userAddress
